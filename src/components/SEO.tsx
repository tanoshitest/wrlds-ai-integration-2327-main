...
const SEO: React.FC<SEOProps> = ({
  ...
  type = 'website',
  name = 'Tanoshi Vietnam Technologies',
  ...
  const blogPostStructuredData = isBlogPost && publishDate ? {
    ...
    author: {
      '@type': 'Organization',
      name: author || 'Tanoshi Vietnam Technologies',
      url: 'https://wrlds.com'
    },
    publisher: {
      '@type': 'Organization',
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="Tanoshi Vietnam Technologies" />
