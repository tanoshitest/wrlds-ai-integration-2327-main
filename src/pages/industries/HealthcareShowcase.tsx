...
const projects = [
  {
    ...
    description: "Virtual healthcare consultation platform with video calls and prescription management"
  },
  {
    title: "Beauty Salon Booking App",
    image: "/lovable-uploads/5ca619e6-2139-4879-9b3c-94777ab85e2a.png",
    description: "Appointment scheduling and beauty service management system"
  },
  {
  ...
  },
  {
    ...
    description: "Health tracking, workout plans, and nutrition monitoring platform"
  }
];
  ...
  return (
    <PageLayout>
      <div className="pt-16 pb-20">
        <section className="bg-gradient-to-br from-pink-900 to-pink-700 text-white py-16">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-pink-100">
                Patient-centric healthcare apps and beauty platforms with booking systems and personalized experiences
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="text-gray-600 text-center max-w-2xl mx-auto">
                Healthcare and beauty solutions that prioritize user experience
              </p>
            </motion.div>
        ...
        <section className="bg-pink-900 text-white py-16">
          <div className="container mx-auto px-6 text-center">
            ...
            <a 
              href="/#contact" 
              className="inline-block bg-white text-pink-900 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
            >
              Contact Us
            </a>
          </div>
