...
const industries = [
  {
    ...
    tagline: "Scalable business software solutions for modern enterprises",
  ...
  },
  {
    ...
    tagline: "Secure and scalable cloud infrastructure and migration",
  ...
  },
  {
    ...
    tagline: "Seamless system integration and API development",
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground mb-8">
                  Custom software solutions tailored to your business needs with cutting-edge technology.
                </p>
                <a href="#showcase">
          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Comprehensive software development expertise across multiple domains
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            ...
            >
              ...
              <p className="text-xl opacity-90 mb-10 leading-relaxed">
                Let's build something amazing together. Whether it's a custom application or system integration, 
