...
import { DollarSign, Heart, GraduationCap, ShoppingCart, Home, Plane, Scale, Sparkles, Gamepad } from 'lucide-react';
...
const industries = [
  ...
  },
  {
    icon: Plane,
    title: "Travel",
    tagline: "Booking systems and travel management platforms",
  ...
  },
  {
    icon: Sparkles,
    title: "Lifestyle",
    tagline: "Wellness, fitness, and lifestyle experience apps",
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground mb-8">
                  We craft modern, high-performing web & mobile apps for every industry.
                </p>
                <a href="#showcase">
          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Specialized design expertise across multiple sectors
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            ...
            >
              ...
              <p className="text-xl opacity-90 mb-10 leading-relaxed">
                Let's build something amazing together. Whether it's a web platform or mobile app, 
