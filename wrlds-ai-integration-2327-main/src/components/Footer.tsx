        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 pb-10 border-b border-gray-700">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6">
              Tanoshi Vietnam Technologies provides an end-to-end platform for the creation and deployment of AI-powered smart sensor devices, giving customers 100% ownership while handling the complete technological development.
            </p>
            <p className="text-gray-300 mb-6">
              Hornsgatan 110<br />
