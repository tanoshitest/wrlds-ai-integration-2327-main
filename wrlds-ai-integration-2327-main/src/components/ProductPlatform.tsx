    ...
    <div className="w-full relative">
      ...
      >
        ...
        <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-4xl">
          5 years invested into tech focused end-to-end platform allowing customer brand to own pricing, branding, marketing and sales. Tanoshi Vietnam can help with all aspects of
      ...
      <div className="flex flex-col lg:flex-row gap-6 w-full">
        ...
        {/* Tanoshi Vietnam Platform Column */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="bg-gray-200 rounded-xl p-4 sm:p-6">
            <div className="flex flex-col items-center mb-3 sm:mb-4">
              <h3 className="text-xl sm:text-2xl font-bold text-center mb-0">Tanoshi Vietnam</h3>
